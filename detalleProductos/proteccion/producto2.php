...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/PROTECCION/producto2.PNG" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Equipo de Protección</div>
      <div class="card-body">
        <h5 class="card-title">RESPIRADOR REUTILIZABLE</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> TANGS</li>
    <li class="list-group-item"><strong>Cantidad unitaria: </strong> 1</li>
    <li class="list-group-item"><strong>Precio: </strong> $546.00</li>
  </ul>
      </div>
