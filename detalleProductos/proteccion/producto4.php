...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/PROTECCION/producto4.PNG" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Equipo de Protección</div>
      <div class="card-body">
        <h5 class="card-title">HOT MILL GUANTES</h5>
    ...
    <li class="list-group-item"><strong>Precio: </strong> $220.00</li>
  </ul>
      </div>
