...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/PROTECCION/producto3.PNG" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Equipo de Protección</div>
      <div class="card-body">
        <h5 class="card-title">MASCARILLA DOBLE FILTRO</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> Carbon Activado</li>
    <li class="list-group-item"><strong>Cantidad unitaria: </strong> 1</li>
    <li class="list-group-item"><strong>Precio: </strong> $550.00</li>
  </ul>
      </div>
