...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/ACCESORIOS/producto4.PNG" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Accesorios Extras</div>
      <div class="card-body">
        <h5 class="card-title">BROCHA DE CERDAS NATURALES </h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> Petrul</li>
    <li class="list-group-item"><strong>Cantidad: </strong> 1</li>
    <li class="list-group-item"><strong>Precio: </strong> $22.00</li>
  </ul>
      </div>
