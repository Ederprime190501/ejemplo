...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/ACCESORIOS/producto5.PNG" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Accesorios Extras</div>
      <div class="card-body">
        <h5 class="card-title">KIT DE HERRAMIENTAS DE PINTURA - 3 PIEZAS </h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> Perfect</li>
    <li class="list-group-item"><strong>Cantidad: </strong> 3</li>
    <li class="list-group-item"><strong>Precio: </strong> $199.00</li>
  </ul>
      </div>
      <div class="card-footer bg-transparent">
          <a href="../../prodAccesorios.php" class="btn btn-danger" role="button">Regresar</a>
