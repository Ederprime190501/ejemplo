...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/ACCESORIOS/producto8.PNG" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Accesorios Extras</div>
      <div class="card-body">
        <h5 class="card-title">KIT DE RODILLO Y BASE PARA PINTURA </h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> HDX</li>
    <li class="list-group-item"><strong>Cantidad: </strong> 2</li>
    <li class="list-group-item"><strong>Precio: </strong> $129.00</li>
  </ul>
      </div>
