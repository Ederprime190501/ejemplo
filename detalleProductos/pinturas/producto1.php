...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/PINTURAS/producto1.png" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Pinturas</div>
      <div class="card-body">
        <h5 class="card-title">PINTURA ESMALTE TECNOBRIL COLOR NEGRO</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: Pinturas Acuario</strong></li>
    <li class="list-group-item"><strong>Cantidad en Lts: </strong> 1Lt</li>
    <li class="list-group-item"><strong>Precio: </strong> $196.00</li>
  </ul>
      </div>
