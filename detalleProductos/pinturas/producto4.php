...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/PINTURAS/producto3.png" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Pinturas</div>
      <div class="card-body">
        <h5 class="card-title">AEROSOL BARNIZ METALICO</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> Motolow</li>
    <li class="list-group-item"><strong>Cantidad en Lts: </strong> 400ml</li>
    <li class="list-group-item"><strong>Precio: </strong> $283.90</li>
  </ul>
      </div>
