    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active enlace1" aria-current="page" href="../../index.php">Inicio</a></li>
...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/PINTURAS/producto5.png" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Pinturas</div>
      <div class="card-body">
        <h5 class="card-title">PINTURAS EN AEROSOL - 12pz.</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> Montana Black</li>
    <li class="list-group-item"><strong>Cantidad en Lts: </strong> 400ml</li>
    <li class="list-group-item"><strong>Precio: </strong> $1500.00</li>
  </ul>
      </div>
      <div class="card-footer bg-transparent">
          <a href="../../prodPinturas.php" class="btn btn-danger" role="button">Regresar</a>
          <a href="../../conocenos.php" class="btn btn-primary" role="button">Comprar</a>
      </div>
    </div>
  </div>
</div>
