...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/SOLVENTES/producto1.png" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Pinturas</div>
      <div class="card-body">
        <h5 class="card-title">REMOVEDOR DE FLUIDO DE DISEÑO</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> Dykem</li>
    <li class="list-group-item"><strong>Cantidad en Lts: </strong> 450ml</li>
    <li class="list-group-item"><strong>Precio: </strong> $251.77</li>
  </ul>
      </div>
      <div class="card-footer bg-transparent">
          <a href="../../prodSolventes.php" class="btn btn-danger" role="button">Regresar</a>
