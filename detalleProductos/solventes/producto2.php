...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/SOLVENTES/producto2.png" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
     <div class="card-header bg-transparent"><strong>Categoria:</strong> Pinturas</div>
      <div class="card-body">
        <h5 class="card-title">SOLVENTE SIN OLOR</h5>
        <ul class="list-group list-group-flush">
    <li class="list-group-item"><strong>Marca: </strong> ATL</li>
    <li class="list-group-item"><strong>Cantidad en Lts: </strong> 245ml</li>
    <li class="list-group-item"><strong>Precio: </strong> $27.00</li>
  </ul>
      </div>
