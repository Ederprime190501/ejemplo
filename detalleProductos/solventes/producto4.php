...
<div class="container">
 <div class="card detalle">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../recursos/img/productos/SOLVENTES/producto4.png" class="img-fluid rounded-start" alt="#">
    </div>
    <div class="col-md-8">
    ...
    <li class="list-group-item"><strong>Marca: </strong> LabMex</li>
    <li class="list-group-item"><strong>Cantidad en Lts: </strong> 1l</li>
    <li class="list-group-item"><strong>Precio: </strong> $502.00</li>
  </ul>
      </div>
